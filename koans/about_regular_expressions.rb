...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # ANSWER:
    #
    # The * (asterisk) in a regular expression means "zero or more" occurrences of the
    # preceding element. It will never fail to match; at minimum, it matches zero occurrences,
  ...
  # ANSWER:
  #
  # Repetition operators like *, +, and ? are called "greedy" because they match as much of the input
  # string as possible. They expand the match to include the maximum number of characters that fit
  # the pattern, only backing off if necessary to allow the rest of the regular expression to match.
  # ------------------------------------------------------------------
  ...
  # ANSWER:
  # A character class ([...]) matches one character from a set of possibilities.
  # Alternation (|) matches one of several patterns, which can be sequences of characters or groups.
  ...
  def test_gsub_is_like_find_and_replace_all
    assert_equal "t-t", "one two-three".gsub(/(t\w*)/) { $1[0, 1] }
  end
end
