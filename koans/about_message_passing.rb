...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # ANSWER: Ruby provides both send and __send__ to avoid conflicts when an object defines
    # its own send method. If an object overrides send, you can still use __send__
    # to reliably invoke methods via message passing.
  end
